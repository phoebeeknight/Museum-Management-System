            ...
            <div class="container">
                <div class="subheader">                             	
                    	<div id="SignUp" class="pull-right">
                          | <a href="1.2.php">SIGN UP</a> |
                         
                          | <a href="1.3.php">SIGN IN</a> |
                    	</div>
                    </div>
                </div>
            </div>
                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        <div class="navbar-header">
                                ...
                                <a href="1.1.php" class="navbar-brand"><img src="images/logo.png" alt="MUSEUM MANAGEMENT SYSTEM" title="MUSEUM MANAGEMENT SYSTEM" /></a>
                        </div>
...
//  {
//
//                        echo'<li class="col-lg-2 col-md-2 col-sm-2  gallery gallery-human"></li>';
//                            echo"<a class='colorbox' href=".$row['artefact_images']." data-group=".$row['artefact_type']."></a>";
//                               echo'<div class="templatemo-project-box"></div>';
//                                    echo"<img src=".$row['artefact_images']." class='img-responsive' alt='gallery'> </img>";
//
//                                    echo'<div class="project-overlay"></div>';
//                                        echo"<h5>".$row['artefact_type']."</h5>";
//                                        echo"<hr></hr>";
//                                        echo"<h4>".$row['artefact_name']."</h4>";
//										echo"<hr></hr>";
//                                        echo"<h4>".$row['artefact_description']."</h4>";
//  }
?>


                        <li class="col-lg-2 col-md-2 col-sm-2  gallery" name="artefact_type" >
                            <a class="colorbox" href="#"  name="artefact_images" data-group="gallery-relic">
                                <div class="templatemo-project-box">
                                    <img src="#" class="img-responsive" alt="gallery" name="artefact_images"/>
                                    <div class="project-overlay" name="artefact_desc">                                        
                                    </div>
                                </div>
                            </a>
                        </li>
...
?>
                        ...
                        <li class="col-lg-2 col-md-2 col-sm-2  gallery gallery-pottery" >
                            <a class="colorbox" href="images/3 vase.jpg" data-group="gallery-pottery">
                                <div class="templatemo-project-box">
                                    <img src="images/3 vase.jpg" class="img-responsive" alt="gallery" />
                                    <div class="project-overlay">
                                        <h5>Ancient Pottery</h5>
                                        <hr />
                                        <h4>INDIAN VASES</h4>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="text-center">
                        ...
                        <div class="footer_bottom_content">
                   			<span id="footer-line">Copyright © 2017 <a href="1.1.php">Museum Management System</a></span>
                        </div>
