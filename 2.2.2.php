                ...
                <div class="row">
                    <div class="templatemo-line-header" >
                        <div class="text-center">
                            ...
                            <span class="txt_darkgrey">EDIT ARTEFACT</span>
...
$result=pg_query($conn,"SELECT * FROM artefact WHERE artefact_id= '$artefact_id'");
while($row=pg_fetch_assoc($result))
//	if($row)
		{
//			$artefact_id=$row['artefact_id'];
			$artefact_name=$row['artefact_name'];
			$artefact_desc=$row['artefact_description'];
			$artefact_type=$row['artefact_type'];
			$artefact_status=$row['artefact_status'];
			$artefact_receivedate=$row['artefact_receivedate'];
			$artefact_year=$row['artefact_year'];
			$artefact_images=$row['artefact_images'];
		}
//		else
//		{
//			echo"ERROR";
...
?>
				...
				<strong><form name="artefact_edit" action="2.2.2.php" method="post" enctype="multipart/form-data"> 
            ...
            <table border="0" align="center" width="720">
                ...
                <div class="input-container">
                 ...
                 <td width="10">:</td>
                 <td width="213"><input type="text" id="artefact_id" name="artefact_id"  style="height:25px;" value="<?php echo $artefact_id;?>" /></td> <!-- add name attribute -->					
				<div class="bar"></div>
				</tr>
                ...
                <div class="input-container">
                 ...
                 <td width="10">:</td>
                 <td width="213"><input type="text" id="artefact_name" name="artefact_name"  style="height:25px;" value="<?php echo $artefact_name;?>" /></td> <!-- add name attribute -->					
				<div class="bar"></div>
				</tr>	
                ...
                <div class="input-container">
                 ...
                 <td width="10">:</td>
                 <td width="213"><textarea rows="3" cols="20" id="artefact_desc" name="artefact_desc" value="<?php echo $artefact_desc;?>"></textarea></td> <!-- add name attribute -->					
				<div class="bar"></div>
				</tr>					
                ...
                <div class="input-container">
                 ...
                 <td width="10">:</td>
                 <td width="213"><select name="artefact_type" value="<?php echo $artefact_type;?>">
                ...
                <div class="input-container">
                 ...
                 <td width="10">:</td>
                 <td width="213"><select name="artefact_status" value="<?php echo $artefact_status;?>">
                ...
                <div class="input-container">
                 ...
                 <td width="10">:</td>
                 <td width="213"><input type="date" id="artefact_receivedate" name="artefact_receivedate" value="<?php echo $artefact_receivedate;?>" /></td> <!-- add name attribute -->					
				<div class="bar"></div>
				</tr>
                ...
                <div class="input-container">
                 ...
                 <td width="10">:</td>
                 <td width="213"><input type="number" id="artefact_year" name="artefact_year" value="<?php echo $artefact_year;?>"/></td> <!-- add name attribute -->					
				<div class="bar"></div>
				</tr>
        		...
        		<td width="10">:</td>
        		<td width="213"><input type="file" id="artefact_images" name="artefact_images" value="<?php echo $artefact_images;?>" /></td>
                <div class="bar"></div>
   			  </tr>
...
if (isset($_POST['submit']))
	...
	$artefact_id=$_REQUEST['artefact_id'];
	$artefact_name=$_REQUEST['artefact_name'];
	$artefact_desc=$_REQUEST['artefact_desc'];
	$artefact_type=$_REQUEST['artefact_type'];
	$artefact_status=$_REQUEST['artefact_status'];
	$artefact_receivedate=$_REQUEST['artefact_receivedate'];
	$artefact_year=$_REQUEST['artefact_year'];
	$artefact_images=$_REQUEST['artefact_images'];
	...
	$query=pg_query($conn,"UPDATE artefact SET artefact_id='".$artefact_id."', artefact_name='".$artefact_name."', artefact_description='".$artefact_desc."', artefact_type='".$artefact_type."', artefact_status='".$artefact_status."', artefact_receiveDate='".$artefact_receivedate."', artefact_year='".$artefact_year."' WHERE artefact_id='".$artefact_id."'");
                ...
                <div class="row">
                    <div class="text-center">
                        ...
                        <div class="footer_container">
                            ...
                            <div class="height30"></div>
                            <a class="btn btn-lg btn-orange" href="2.2.2.php" role="button">Back To Top</a>
                            <div class="height30"></div>
                        </div>
